...
1. Save the output to the story-specific handoff file under `masterskaya-pisatelya-PRIVATE/stories/<story-slug>/02-handoffs/`.
...
5. Update `masterskaya-pisatelya-PRIVATE/stories/<story-slug>/06-agent-queue/agent-queue.md` when running from a queued route.
