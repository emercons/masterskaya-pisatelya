...
This copied folder is expected to be private story material when placed under `../knigi-content-private/stories/`. Keep it tracked only when the repository itself is meant to stay private.
