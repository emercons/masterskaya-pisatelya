...
| 4 | Scene workspace | Держит вход, handoff, canonical state, exports | S | Да | Markdown folders + Git | Уже реализуется через соседний private repo `../knigi-content-private/stories/<slug>/`. |
