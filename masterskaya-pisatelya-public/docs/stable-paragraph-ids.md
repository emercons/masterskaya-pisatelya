...
Story-facing exports under `../knigi-content-private/stories/<story-slug>/05-exports/` should use these paragraph IDs by default when they are intended for author review.
