...
`../knigi-content-private/` is deliberately a separate private repository, not a subtree of this public infrastructure repository. Story content may be tracked there, but should not be committed here.
...
```text
../knigi-content-private/stories/chelovek-kak-biologicheskiy-ai-agent/05-exports/full-draft-v6-05-07.md
```
...
Use `../knigi-content-private/stories/<story-slug>/06-agent-queue/agent-queue.md` to continue work across sessions. A new session should read the queue, canonical state, the latest relevant handoff, and the relevant draft fragment, not the full old conversation.
